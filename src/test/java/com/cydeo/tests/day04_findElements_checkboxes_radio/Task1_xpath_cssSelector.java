...
public class Task1_xpath_cssSelector {
    ...
    public static void main(String[] args) {
        ...
        /*  DO NOT USE ANY DEVELOPER TOOLS TO GET LOCATORS.

        Task 1: XPATH and cssSelector Practices
        ...
        /* 3. Locate all the WebElements on the page using XPATH or CSS locator only (total of 6)

           a. “Home” link

           Locate homeLink by using cssSelector, class value */
        WebElement homeLink1=driver.findElement(By.cssSelector("a[class='nav-link']"));

        // Locate homeLInk by using cssSelector syntax #2
