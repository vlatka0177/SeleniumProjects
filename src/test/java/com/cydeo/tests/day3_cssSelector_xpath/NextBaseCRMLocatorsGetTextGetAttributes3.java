...
public class NextBaseCRMLocatorsGetTextGetAttributes3 {

    public static void main(String[] args) {

         /* Task #4: NextBaseCRM, locators, getText(), getAttribute() practice
        ...
        /* 3. Verify "Reset password" button text is as expected:
           ...
           Locating reset password button by using class attribute and its value.
           WebElement resetPasswordButton = driver.findElement(By.cssSelector("button[class='login-btn']"));

           Locating reset password button by using value attribute and its value.        */
